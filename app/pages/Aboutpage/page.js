        ...
        <div className="imgCollageContainer">
          <div className="collage-row">
            <div className="collage-cols">
              <img src="/image/collage1.png" alt="fit" width={500} height={500} />
            </div>

            <div className="collage-cols">
              <div className="collage-card">
                <img src="/image/collage2.png" alt="fit" width={500} height={500} />
              </div>
              <div className="collage-card">
                <img src="/image/collage3.png" alt="fit" width={500} height={500} />
              </div>
            </div>

            <div className="collage-cols">
              <img src="/image/collage4.png" alt="fit" width={500} height={500} />
            </div>

            <div className="collage-cols">
              <div className="collage-card">
                <img src="/image/collage5.png" alt="fit" width={500} height={500} />
              </div>
              <div className="collage-card">
                <img src="/image/collage6.png" alt="fit" width={500} height={500} />
              </div>
            </div>
 
            <div className="collage-cols">
              <img src="/image/collage7.png" alt="fit" width={500} height={500} />
            </div>
          ...
          <div className="shopping-row">
            ...
            <div className="shopping-col">
              <div className="shopping-details">
                ...
                <img src="/image/shopping1.png" alt="fit" width={100} height={100} />
                </div>
            ...
            <div className="shopping-col">
              <div className="shopping-details">
                <div className="shopping-img">
                <img src="/image/shopping2.png" alt="fit" width={100} height={100} />
                </div>
                <div className="shopping-info">
                  <h4>Mix and Match</h4>
            ...
            <div className="shopping-col">
              <div className="shopping-details">
                <div className="shopping-img">
                <img src="/image/shopping3.png" alt="fit" width={100} height={100} />
                </div>
                <div className="shopping-info">
          ...
          <div className="tools-row">
            <div className="tools-col">
              <div className="tools-img">
                <img src="/image/banner-11.png" alt="fit" width={600} height={450} />
              </div>
            </div>
            <div className="tools-col">
        ...
        <div className="fit-container">
          <div className="fit-row">
            ...
            <div className="fit-col">
              <div className="fit-card">
                <div className="fit-Img">
                  <img src="/image/fit1.png" alt="fit" width={500} height={500} />
                </div>
            ...
            <div className="fit-col">
              <div className="fit-card">
                <div className="fit-Img">
                  <img src="/image/fit2.png" alt="fit" width={500} height={600} />
                </div>
            ...
            <div className="fit-col">
              <div className="fit-card">
                <div className="fit-Img">
                  <img src="/image/fit3.png" alt="fit" width={500} height={500} />
                </div>
          ...
          <div className="team-row">
            ...
            <div className="team-col">
              <div className="team-card">
                ...
                <img src="/image/team1.png" alt="fit" width={250} height={350} />
                </div>
            ...
            <div className="team-col">
              <div className="team-card">
                <div className="team-img">
                <img src="/image/team2.png" alt="fit" width={250} height={270} />
                </div>
                <div className="team-info">
                <h4>Business</h4>
                <p>You’ve got the ideas, we’ve got the tools</p>
            ...
            <div className="team-col">
              <div className="team-card">
                <div className="team-img">
                <img src="/image/team3.png" alt="fit" width={250} height={350} />
                </div>
                <div className="team-info">
                <h4>Family</h4>
                <p>You’ve got the ideas, we’ve got the tools</p>
            ...
            <div className="team-col">
              <div className="team-card">
                <div className="team-img">
                <img src="/image/team4.png" alt="fit" width={250} height={270} />
                </div>
                <div className="team-info">
                <h4>Event</h4>
                <p>You’ve got the ideas, we’ve got the tools</p>
